...
export default function PricingSection() {
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          className="mx-auto w-[1155px] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30"
          style={{
            clipPath:
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-2 text-5xl font-semibold tracking-tight sm:text-6xl text-gray-900">
          Choose the right plan for you
        </p>
      </div>
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg sm:text-xl text-gray-600">
      ...
      <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 gap-y-6 sm:mt-20 lg:max-w-4xl lg:grid-cols-2">
        ...
        <div className="rounded-3xl bg-white/60 p-8 ring-1 ring-gray-900/10 sm:p-10">
          ...
          <a
            href="#"
            className="mt-8 block rounded-md px-3.5 py-2.5 text-center text-sm font-semibold text-indigo-600 ring-1 ring-indigo-200 hover:ring-indigo-300 sm:mt-10"
          >
            Get started today
          </a>
        </div>
        ...
        <div className="relative rounded-3xl bg-gray-900 p-8 shadow-2xl ring-1 ring-gray-900/10 sm:p-10">
          <h3 id="tier-enterprise" className="text-base font-semibold leading-7 text-indigo-400">
            Enterprise
          </h3>
...
/* tiny check-mark icon component */
function CheckIcon() {
  return (
